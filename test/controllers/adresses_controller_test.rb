...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { address1: @adress.address1, adress2: @adress.adress2, city: @adress.city, country: @adress.country, phone: @adress.phone, zip: @adress.zip } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { address1: @adress.address1, adress2: @adress.adress2, city: @adress.city, country: @adress.country, phone: @adress.phone, zip: @adress.zip } }
